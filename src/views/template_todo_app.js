 function geraView(dados){
    ...
    dados.forEach((element, index) => {
        ...
        <div class="card-body">
          ...
          <button class="btn btn-light edit">Editar</button>
          <button class="btn btn-danger delete">Deletar</button>
        </div>
      </div>`
    });
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="w-50 p-4 border rounded shadow-sm"> 
                <form id="formHttp" class="flex-fill" action="/" method="post">
        ...
        <script src="estatico/deleteCard.js"></script>
        <script src="estatico/updateCard.js"></script>
    </body>
    </html>`
    }
